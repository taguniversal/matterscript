...
11 expected outcomes, 14 unexpected outcomes.
...
| TAG-143 | example-12.2.ms.ipl | Partial | ok | ok | 🟡 unexpected pass |
| TAG-146 | example-12.12.ms.ipl | Partial | ok | ok | 🟡 unexpected pass |
| TAG-147 | example-12.13.ms.ipl | Partial | ok | ok | 🟡 unexpected pass |
| TAG-148 | example-12.11.ms.ipl | Partial | ok | ok | 🟡 unexpected pass |
...
| TAG-180 | example-12.10.ms.ipl | Partial | ok | ok | 🟡 unexpected pass |
| TAG-181 | example-12.11.ms.ipl | Partial | ok | ok | 🟡 unexpected pass |
...
| TAG-189 | example-12.14-arbitration.ms.ipl | Partial | ok | ok | 🟡 unexpected pass |
