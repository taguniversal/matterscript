...
[Introduction: The Missing Dimension in Programming](introduction.md)

# Part I: Rethinking Computation
- [Introduction](part-01-rethinking-computation/index.md)
- [Why Software Forgot Geometry](part-01-rethinking-computation/01-why-software-forgot-geometry.md)
- [Time is Not a Clock](part-01-rethinking-computation/02-time-is-not-a-clock.md)
- [The Cost of Abstraction](part-01-rethinking-computation/03-the-cost-of-abstraction.md)
- [Hardware Already Knows the Answer](part-01-rethinking-computation/04-hardware-already-knows-the-answer.md)
- [Introducing Space-Time Programming](part-01-rethinking-computation/05-introducing-space-time-programming.md)

# Part II: The Computational Universe
- [Introduction](part-02-computational-universe/index.md)
...
- [Introduction](part-04-learning-matterscript/index.md)
- [Language Overview](part-04-learning-matterscript/01-language-overview.md)
- [Files and Projects](part-04-learning-matterscript/02-files-and-projects.md)
...
- [Edges](part-05-geometry-becomes-code/02.1-edges.md)
- [Loops](part-05-geometry-becomes-code/02.2-loops.md)
- [Faces](part-05-geometry-becomes-code/02.3-faces.md)
- [Meshes](part-05-geometry-becomes-code/02.4-meshes.md)
...
- [Propagation Instead of Execution](part-07-programming-space-time/01-propagation-instead-of-execution.md)
- [Space-Time Coordinates](part-07-programming-space-time/02-space-time-coordinates.md)
- [Local Causality](part-07-programming-space-time/03-local-causality.md)
- [Global Emergence](part-07-programming-space-time/04-global-emergence.md)
- [Deterministic Physical Computing](part-07-programming-space-time/05-deterministic-physical-computing.md)
- [Software Meets Semiconductor Physics](part-07-programming-space-time/06-software-meets-semiconductor-physics.md)
...
- [C & POSIX Code Generation](part-08-compilers-and-code-generation/08-c-posix-code-generation.md)
- [POSIX Runtimes](part-08-compilers-and-code-generation/09-nuttx-rtos-embedded.md)
- [Verification](part-08-compilers-and-code-generation/10-verification.md)

# Part IX: Runtimes & Hardware Targets
- [FPGA Synthesis & Bitstreams](part-09-runtimes/01-fpga-synthesis.md)
- [WebGPU Compute Engine](part-09-runtimes/02-webgpu-compute-engine.md) 
- [NuttX & Embedded POSIX](part-09-runtimes/03-nuttx-rtos-embedded.md)
- [Verification & Co-Simulation](part-09-runtimes/04-verification.md)

# Part X: World Modeling
- [Introduction](part-10-world-modeling/index.md)
- [Engineering Knowledge as Software](part-10-world-modeling/01-engineering-knowledge-as-software.md)
- [Building a Radiator](part-10-world-modeling/02-building-a-radiator.md)
- [From Radiator to Automobile](part-10-world-modeling/03-from-radiator-to-automobile.md)
- [From Automobile to City](part-10-world-modeling/04-from-automobile-to-city.md)
- [Human-AI Collaboration](part-10-world-modeling/05-human-ai-collaboration.md)
- [Executable World Models](part-10-world-modeling/06-executable-world-models.md)

# Part XI: Distributed Space-Time Systems
- [Introduction](part-11-distributed-space-time-systems/index.md)
- [Distributed Tokens](part-11-distributed-space-time-systems/01-distributed-tokens.md)
- [Temporal Address Spaces](part-11-distributed-space-time-systems/02-temporal-address-spaces.md)
- [Deterministic Synchronization](part-11-distributed-space-time-systems/03-deterministic-synchronization.md)
- [Edge Computing](part-11-distributed-space-time-systems/04-edge-computing.md)
- [Robotics](part-11-distributed-space-time-systems/05-robotics.md)
- [Digital Twins](part-11-distributed-space-time-systems/06-digital-twins.md)
- [Planetary Scale Simulation](part-11-distributed-space-time-systems/07-planetary-scale-simulation.md)
...
- [Drone Swarm](part-12-complete-projects/08-drone-swarm.md)
- [Automotive Radiator](part-12-complete-projects/09-automotive-radiator.md)
- [Digital Earth](part-12-complete-projects/10-digital-earth.md)

---

# Appendices
- [Appendix A: Language Reference](appendices/appendix-a-language-reference.md)
- [Appendix B: Grammar Specification](appendices/appendix-b-grammar-specification.md)
- [Appendix C: Compiler Internals](appendices/appendix-c-compiler-internals.md)
- [Appendix D: Standard Library Reference](appendices/appendix-d-standard-library-reference.md)
- [Appendix E: Invocation Language Reference](appendices/appendix-e-invocation-language-reference.md)
- [Appendix F: Mathematics of Geometry-Aware Placement](appendices/appendix-f-mathematics-of-geometry-aware-placement.md)
- [Appendix G: Building the Compiler](appendices/appendix-g-building-the-compiler.md)
- [Appendix H: Future Directions](appendices/appendix-h-future-directions.md)
