...
pub fn build(b: *std.Build) void {
    ...
    const spatial_domain_tests = b.addTest(.{
        .root_module = b.createModule(.{
            .root_source_file = b.path("src/tests/spatial_domain_test.zig"),
            .target = target,
            .optimize = optimize,
            .imports = &.{
                .{ .name = "matterscript", .module = matterscript_mod },
    ...
    const runtime_and2_wires_test = b.addTest(.{
        .root_module = b.createModule(.{
            .root_source_file = b.path("src/tests/runtime_and2_wires_test.zig"),
            .target = target,
            .optimize = optimize,
            .imports = &.{
                .{ .name = "matterscript", .module = matterscript_mod },
    ...
    const harness_tests = b.addTest(.{
        .root_module = b.createModule(.{
            .root_source_file = b.path("src/tests/harness_tests.zig"),
            .target = target,
            .optimize = optimize,
            .imports = &.{
                .{ .name = "matterscript", .module = matterscript_mod },
    ...
    const example_12_35_tests = b.addTest(.{
        .root_module = b.createModule(.{
            .root_source_file = b.path("src/tests/if_then_else_test.zig"),
            .target = target,
            .optimize = optimize,
            .imports = &.{
                .{ .name = "matterscript", .module = matterscript_mod },
